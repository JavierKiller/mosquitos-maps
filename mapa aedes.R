...
# Guardar como HTML
saveWidget(mapa, "mapas_interactivos/mapa_calor_aedes.html", selfcontained = TRUE)
...
saveWidget(mapa, "mapas_interactivos/mapa_calor_aedes_por_año.html", selfcontained = TRUE)
